defmodule UrlsTest do
  ...
  test "Urls are constructed correctly based on type" do
    ...
    actual =
      %{
        :assets => XeroXero.Utils.Urls.api("resource", :assets),
        :core => XeroXero.Utils.Urls.api("resource", :core),
        :files => XeroXero.Utils.Urls.api("resource", :files),
        :payroll => XeroXero.Utils.Urls.api("resource", :payroll)
      }
  ...
  test "Query params are constructed, and encoded, correctly" do
    ...
    query_string = XeroXero.Utils.Urls.append_query_filters "", query_filters
