defmodule XeroXero.Public do
  ...
  def get_request_token do
    ...
    header = XeroXero.Utils.Oauth.create_auth_header("GET", request_token_url, [oauth_callback: callback_url], nil)
  ...
  def approve_access_token(request_token, verifier) do
    ...
    header = XeroXero.Utils.Oauth.create_auth_header("GET", access_token_url, [oauth_token: request_token["oauth_token"], oauth_verifier: verifier], request_token)
  ...
  def find(access_token, resource, api_type) do
    ...
    header = XeroXero.Utils.Oauth.create_auth_header("GET", url, [oauth_token: access_token["oauth_token"]], access_token)
  ...
  def create(access_token, resource, api_type, data_map) do
    ...
    header = XeroXero.Utils.Oauth.create_auth_header(method, url, [oauth_token: access_token["oauth_token"]], access_token)
  ...
  def delete(access_token, resource, api_type) do
    ...
    header = XeroXero.Utils.Oauth.create_auth_header("DELETE", url, [oauth_token: access_token["oauth_token"]], access_token)
  ...
  def upload_multipart(access_token, resource, api_type, path_to_file, name) do
    ...
    header = XeroXero.Utils.Oauth.create_auth_header("POST", url, [oauth_token: access_token["oauth_token"]], access_token)
  ...
  def upload_attachment(access_token, resource, api_type, path_to_file, filename, include_online) do
    ...
    header = XeroXero.Utils.Oauth.create_auth_header("POST", url_for_signing, [oauth_token: access_token["oauth_token"]], access_token)
