defmodule XeroXero.CoreApi.Models.ManualJournals.ManualJournal do
    use Ecto.Schema
    ...
    schema "manualjournals" do
        ...
        embeds_many :JournalLines, XeroXero.CoreApi.Models.ManualJournals.ManualJournal.JournalLine
