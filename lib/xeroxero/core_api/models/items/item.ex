defmodule XeroXero.CoreApi.Models.Items.Item do
    use Ecto.Schema
    ...
    schema "items" do
        ...
        embeds_one :PurchaseDetails, XeroXero.CoreApi.Models.Items.Item.ItemDetails
        embeds_one :SalesDetails, XeroXero.CoreApi.Models.Items.Item.ItemDetails
