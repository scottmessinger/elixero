defmodule XeroXero.CoreApi.Models.Journals.Journal.JournalLine do
    use Ecto.Schema
    ...
    schema "journallines" do
        ...
        embeds_many :TrackingCategories, XeroXero.CoreApi.Models.Common.LineItems.TrackingCategory
